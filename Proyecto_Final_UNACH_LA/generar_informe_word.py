...
def generar_informe():
    ...
    add_heading_apa(doc, "8. ARQUITECTURA TÉCNICA COMPLETA DEL SISTEMA", 1)
    ...
    # ========================================================================
    # CAPÍTULO 13: RESULTADOS CONSOLIDADOS
    # ========================================================================
    print("  >> Capítulo 13: Resultados consolidados...")
    add_heading_apa(doc, "9. RESULTADOS CONSOLIDADOS Y MÉTRICAS FINALES", 1)

    add_heading_apa(doc, "9.1 Resultados de la Implementación del Sistema", 2)
    add_paragraph_apa(doc,
    ...
    add_heading_apa(doc, "10. CONCLUSIONES Y RECOMENDACIONES", 1)

    add_heading_apa(doc, "10.1 Conclusiones del Prototipo", 2)
    ...
    add_heading_apa(doc, "10.2 Recomendaciones del Prototipo", 2)
    recomendaciones = [
    ...
    add_heading_apa(doc, "12. BIBLIOGRAFÍA Y REFERENCIAS", 1)

    add_heading_apa(doc, "12.1 Referencias Bibliográficas", 2)
    ...
    add_heading_apa(doc, "12.2 Documentación Técnica", 2)
    docs_tecnicos = [
    ...
    add_heading_apa(doc, "12.3 Normativa Consultada", 2)
    normativa = [
    ...
    add_heading_apa(doc, "13. ANEXOS", 1)
