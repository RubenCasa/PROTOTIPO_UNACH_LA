...
def generar_informe():
    ...
    # ========================================================================
    print("  >> Capítulo 5: Arquitectura técnica...")
    ...
    # ========================================================================
    print("  >> Capítulo 6: Resultados consolidados...")
    ...
    # ========================================================================
    print("  >> Capítulo 7: Conclusiones...")
    add_heading_apa(doc, "7. CONCLUSIONES Y RECOMENDACIONES", 1)

    add_heading_apa(doc, "7.1 Conclusiones", 2)
    ...
    add_heading_apa(doc, "7.2 Recomendaciones", 2)
    recomendaciones = [
